...
public class ClientRegistry
{
    ...
    {
        event.getItemColors().register( BASIC_COLOR, ComputerCraft.Items.disk );
        ...
        event.getItemColors().register( BASIC_COLOR, ComputerCraft.Blocks.turtleNormal, ComputerCraft.Blocks.turtleAdvanced );
    }
    ...
    private static final IItemColor BASIC_COLOR = ( stack, tintIndex ) -> {
        if( tintIndex == 0 )
        {
            int colour = ((IColouredItem) stack.getItem()).getColour( stack );
            return colour == -1 ? 0xFFFFFF : colour;
        }
