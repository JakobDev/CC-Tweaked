...
public class WidgetTerminal implements GuiEventListener
{
    ...
    public boolean mouseClicked( double mouseX, double mouseY, int button )
    {
        ...
        if( term != null )
        {
            ...
            queueEvent( "mouse_click", button + 1, charX + 1, charY + 1 );
    ...
    public boolean mouseReleased( double mouseX, double mouseY, int button )
    {
        ...
        if( term != null )
        {
            ...
            {
                queueEvent( "mouse_up", lastMouseButton + 1, charX + 1, charY + 1 );
                lastMouseButton = -1;
            }
    ...
    public boolean mouseDragged( double mouseX, double mouseY, int button, double v2, double v3 )
    {
        ...
        if( term != null )
        {
            ...
            queueEvent( "mouse_drag", button + 1, charX + 1, charY + 1 );
    ...
    public void mouseMoved( double mouseX, double mouseY )
    {
        ...
        int charX = (int) (mouseX / FixedWidthFontRenderer.FONT_WIDTH);
        int charY = (int) (mouseY / FixedWidthFontRenderer.FONT_HEIGHT);
        lastMouseX = Math.min( Math.max( charX, 0 ), term.getWidth() - 1 );
        lastMouseY = Math.min( Math.max( charY, 0 ), term.getHeight() - 1 );
    }
    ...
    @Override
    public void setHasFocus( boolean focused )
    {
        if( !focused )
        {
            ...
            {
                queueEvent( "mouse_up", lastMouseButton + 1, lastMouseX + 1, lastMouseY + 1 );
                lastMouseButton = -1;
            }
