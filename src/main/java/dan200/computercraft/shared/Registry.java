...
public final class Registry
{
    ...
    public static void registerBlocks( RegistryEvent.Register<Block> event )
    {
        ...
        ComputerCraft.Blocks.computerNormal = new BlockComputer(
            Block.Builder.create( Material.ROCK ).hardnessAndResistance( 2.0f ),
        ...
        ComputerCraft.Blocks.computerCommand = new BlockComputer(
            Block.Builder.create( Material.ROCK ).hardnessAndResistance( -1, 6000000.0F ),
        ...
        ComputerCraft.Blocks.turtleNormal = new BlockTurtle(
            Block.Builder.create( Material.ROCK ).hardnessAndResistance( 2.5f ),
        ...
        ComputerCraft.Blocks.speaker = new BlockSpeaker(
            Block.Builder.create( Material.ROCK ).hardnessAndResistance( 2 )
        );
        ...
        ComputerCraft.Blocks.wiredModemFull = new BlockWiredModemFull(
            Block.Builder.create( Material.ROCK ).hardnessAndResistance( 1.5f )
        );
    ...
    public static void registerTileEntities( RegistryEvent.Register<TileEntityType<?>> event )
    {
        ...
        // Computers
        registry.register( TileComputer.FACTORY_NORMAL );
        registry.register( TileComputer.FACTORY_ADVANCED );
        registry.register( TileCommandComputer.FACTORY );

        // Turtles
        registry.register( TileTurtle.FACTORY_NORMAL );
        registry.register( TileTurtle.FACTORY_ADVANCED );

        // Peripherals
        registry.register( TileSpeaker.FACTORY );
        registry.register( TileDiskDrive.FACTORY );
        registry.register( TilePrinter.FACTORY );

        registry.register( TileMonitor.FACTORY_NORMAL );
        registry.register( TileMonitor.FACTORY_ADVANCED );

        registry.register( TileWirelessModem.FACTORY_NORMAL );
        registry.register( TileWirelessModem.FACTORY_ADVANCED );
        registry.register( TileCable.FACTORY );
        registry.register( TileWiredModemFull.FACTORY );
    }
    ...
    private static Item.Builder defaultItem()
    {
        return new Item.Builder().group( mainItemGroup );
    }
    ...
    {
        // Upgrades
        ComputerCraft.TurtleUpgrades.wirelessModemNormal = new TurtleModem( false, new ResourceLocation( ComputerCraft.MOD_ID, "wireless_modem" ) );
        TurtleUpgrades.register( ComputerCraft.TurtleUpgrades.wirelessModemNormal );

        ComputerCraft.TurtleUpgrades.wirelessModemAdvanced = new TurtleModem( true, new ResourceLocation( "computercraft", "advanced_modem" ) );
