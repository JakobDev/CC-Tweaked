...
{
    public static final ResourceLocation COMPUTER_DROP = new ResourceLocation( ComputerCraft.MOD_ID, "computer" );

    private final ComputerFamily family;

    protected BlockComputerBase( Builder settings, ComputerFamily family, TileEntityType<? extends T> type )
    {
        super( settings, type );
        this.family = family;
    }
