...
public abstract class ItemBlockCable extends ItemBlock
{
    ...
    public ItemBlockCable( BlockCable block, Builder settings )
    {
    ...
    {
        if( this.isInGroup( group ) ) list.add( new ItemStack( this ) );
    }
    ...
    {
        public WiredModem( BlockCable block, Builder settings )
        {
            super( block, settings );
        }
    ...
    {
        public Cable( BlockCable block, Builder settings )
        {
            super( block, settings );
        }
