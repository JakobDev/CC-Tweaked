...
public class BlockWirelessModem extends BlockGeneric
{
    ...
    public BlockWirelessModem( Builder settings, TileEntityType<? extends TileWirelessModem> type )
    {
        super( settings, type );
    ...
    {
        return getDefaultState().with( FACING, placement.getFace().getOpposite() );
    }
